...
import './TrackLibraryCard.scss'

class TrackLibraryCard extends Component {
  constructor(props) {
    super(props)
        ...
        <div className="lib-content border-left-5">
          <Media>
            ...
            <Media.Body>
              ...
              <Media.Heading className="dsl-b14 col-xs-5 px-0 bold">Track name</Media.Heading>

              <p className="dsl-d12 col-xs-2 px-0 mr-2">Courses:12</p>
              <p className="dsl-d12 col-xs-2 px-0 mr-2">Modules:21</p>
              <p className="dsl-d12 col-xs-2 px-0 mr-2">Assigned:23</p>
...
export default TrackLibraryCard
