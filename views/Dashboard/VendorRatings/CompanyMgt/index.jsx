  ...
  return (
    <>
      <div className="d-flex mb-4">
        ...
        <span className="dsl-m14 ml-2">Company Mgt</span>
      </div>
      <div className="super-admin-companymgt card">
        <div className="d-flex justify-content-between">
          <p className="dsl-b22 bold">Company Management</p>
          <EditDropdown options={['Add Company']} onChange={() => {}} />
        </div>
